...
- In the real cocotb track, sketch clk, d
- Write why q updates at the edge, not when d changes alone
- Optional: after a cocotb run that dumps waves
...
- When you are ready, take the short quiz, then continue to run a cocotb example offline
